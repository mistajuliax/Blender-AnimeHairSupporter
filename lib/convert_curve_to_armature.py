...
class OBJECT_OP_ahs_convert_curve_to_armature(bpy.types.Operator):
    ...
    bl_description = "Create Armature along Curve"
    bl_options = {'REGISTER', 'UNDO'}

    bone_subdivide_count = bpy.props.IntProperty(name="Bone subdivisions", default=1, min=0, max=8, soft_min=0, soft_max=8)
